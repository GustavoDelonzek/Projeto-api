...
function Home() {
  ...
  const [dataEscolhida, setDataEscolhida] = useState(dataAtual()); //Data aleatoria pois a função dataAtual() buga na virada de um dia pro outro. Coloquei uma data aleatoria pq o proposito é realmente o usuario escolher a data que ele quer contanto que seja válida.
  ...
  return (
    <main className="d-flex flex-column justify-content-center">
      ...
      <section className="introducao d-flex p-5">
        <div className="col-lg-7 d-flex justify-content-center align-items-center texto-introducao">
        ...
        <div className="col-lg-5 text-center p-2 imagem-introducao">
